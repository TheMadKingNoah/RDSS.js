...
export default class EmbedBuilds {
    ...
    public static tipOfTheDayArray = [
        `When issuing a ban or requesting one, it's important to use either </whois roblox:977319353156526141> or </whois discord:977319353156526141> (you can also search <#${Properties.channels.verifyLogs}>) to check for any possible alternate accounts that may need to be banned as well.\n\n> Fun fact! The upcoming verification bot will be able to automatically ban any Discord accounts linked to the Roblox account of the banned user.`,
